...
gdjs.TextoCode.GDvoltarTextoObjects1= [];
gdjs.TextoCode.GDvoltarTextoObjects2= [];
...
for(var i = 0, k = 0, l = gdjs.TextoCode.GDtextoObjects1.length;i<l;++i) {
    if ( gdjs.TextoCode.GDtextoObjects1[i].getAnimation() != 5 ) {
...
gdjs.TextoCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(6878020);
}
}}
}
}
...
{
{gdjs.TextoCode.conditionTrue_1 = gdjs.TextoCode.condition4IsTrue_0;
gdjs.TextoCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(6785652);
}
}}
}
}
...
{
{gdjs.TextoCode.conditionTrue_1 = gdjs.TextoCode.condition4IsTrue_0;
gdjs.TextoCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(6787204);
}
}}
}
}
...
{
{gdjs.TextoCode.conditionTrue_1 = gdjs.TextoCode.condition4IsTrue_0;
gdjs.TextoCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(6778252);
}
}}
}
}
...
gdjs.TextoCode.GDvoltarTextoObjects1.length = 0;
gdjs.TextoCode.GDvoltarTextoObjects2.length = 0;
