...
gdjs.A4Code.mapOfGDgdjs_46A4Code_46GD1Objects2Objects = Hashtable.newFrom({"1": gdjs.A4Code.GD1Objects2});gdjs.A4Code.mapOfGDgdjs_46A4Code_46GD4Objects2Objects = Hashtable.newFrom({"4": gdjs.A4Code.GD4Objects2});gdjs.A4Code.mapOfGDgdjs_46A4Code_46GD2Objects2Objects = Hashtable.newFrom({"2": gdjs.A4Code.GD2Objects2});gdjs.A4Code.mapOfGDgdjs_46A4Code_46GD3Objects1Objects = Hashtable.newFrom({"3": gdjs.A4Code.GD3Objects1});gdjs.A4Code.eventsList0xb25a8 = function(runtimeScene) {
...
gdjs.A4Code.GD1Objects1_1final.length = 0;gdjs.A4Code.GD2Objects1_1final.length = 0;gdjs.A4Code.GD4Objects1_1final.length = 0;gdjs.A4Code.condition0IsTrue_1.val = false;
gdjs.A4Code.condition1IsTrue_1.val = false;
gdjs.A4Code.condition2IsTrue_1.val = false;
{
...
gdjs.A4Code.condition2IsTrue_1.val = gdjs.evtTools.input.cursorOnObject(gdjs.A4Code.mapOfGDgdjs_46A4Code_46GD2Objects2Objects, runtimeScene, true, false);
...
gdjs.A4Code.condition1IsTrue_0.val = false;
{
gdjs.A4Code.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.A4Code.mapOfGDgdjs_46A4Code_46GD3Objects1Objects, runtimeScene, true, false);
}if ( gdjs.A4Code.condition0IsTrue_0.val ) {
{
...
gdjs.A4Code.condition0IsTrue_0.val = false;
{
gdjs.A4Code.condition0IsTrue_0.val = gdjs.evtTools.common.getVariableNumber(runtimeScene.getVariables().getFromIndex(3)) == 0;
}if (gdjs.A4Code.condition0IsTrue_0.val) {
...
{for(var i = 0, len = gdjs.A4Code.GD1Objects1.length ;i < len;++i) {
    gdjs.A4Code.GD1Objects1[i].setPosition(416,448);
}
}{for(var i = 0, len = gdjs.A4Code.GD2Objects1.length ;i < len;++i) {
    gdjs.A4Code.GD2Objects1[i].setPosition(64,448);
}
}{for(var i = 0, len = gdjs.A4Code.GD3Objects1.length ;i < len;++i) {
    gdjs.A4Code.GD3Objects1[i].setPosition(416,128);
}
}{for(var i = 0, len = gdjs.A4Code.GD4Objects1.length ;i < len;++i) {
    gdjs.A4Code.GD4Objects1[i].setPosition(64,128);
}
}}
...
gdjs.A4Code.condition0IsTrue_0.val = false;
{
gdjs.A4Code.condition0IsTrue_0.val = gdjs.evtTools.common.getVariableNumber(runtimeScene.getVariables().getFromIndex(3)) == 1;
}if (gdjs.A4Code.condition0IsTrue_0.val) {
gdjs.A4Code.GD1Objects1.createFrom(runtimeScene.getObjects("1"));
gdjs.A4Code.GD2Objects1.createFrom(runtimeScene.getObjects("2"));
gdjs.A4Code.GD3Objects1.createFrom(runtimeScene.getObjects("3"));
gdjs.A4Code.GD4Objects1.createFrom(runtimeScene.getObjects("4"));
{for(var i = 0, len = gdjs.A4Code.GD3Objects1.length ;i < len;++i) {
    gdjs.A4Code.GD3Objects1[i].setPosition(416,448);
}
}{for(var i = 0, len = gdjs.A4Code.GD2Objects1.length ;i < len;++i) {
    gdjs.A4Code.GD2Objects1[i].setPosition(64,448);
}
}{for(var i = 0, len = gdjs.A4Code.GD1Objects1.length ;i < len;++i) {
    gdjs.A4Code.GD1Objects1[i].setPosition(416,128);
}
}{for(var i = 0, len = gdjs.A4Code.GD4Objects1.length ;i < len;++i) {
    gdjs.A4Code.GD4Objects1[i].setPosition(64,128);
}
...
gdjs.A4Code.condition0IsTrue_0.val = false;
{
gdjs.A4Code.condition0IsTrue_0.val = gdjs.evtTools.common.getVariableNumber(runtimeScene.getVariables().getFromIndex(3)) == 2;
}if (gdjs.A4Code.condition0IsTrue_0.val) {
gdjs.A4Code.GD1Objects1.createFrom(runtimeScene.getObjects("1"));
gdjs.A4Code.GD2Objects1.createFrom(runtimeScene.getObjects("2"));
gdjs.A4Code.GD3Objects1.createFrom(runtimeScene.getObjects("3"));
gdjs.A4Code.GD4Objects1.createFrom(runtimeScene.getObjects("4"));
{for(var i = 0, len = gdjs.A4Code.GD2Objects1.length ;i < len;++i) {
    gdjs.A4Code.GD2Objects1[i].setPosition(416,448);
}
}{for(var i = 0, len = gdjs.A4Code.GD1Objects1.length ;i < len;++i) {
    gdjs.A4Code.GD1Objects1[i].setPosition(64,448);
}
}{for(var i = 0, len = gdjs.A4Code.GD4Objects1.length ;i < len;++i) {
    gdjs.A4Code.GD4Objects1[i].setPosition(416,128);
}
}{for(var i = 0, len = gdjs.A4Code.GD3Objects1.length ;i < len;++i) {
    gdjs.A4Code.GD3Objects1[i].setPosition(64,128);
}
}}
