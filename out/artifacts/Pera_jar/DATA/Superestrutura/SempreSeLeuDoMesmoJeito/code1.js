...
for(var i = 0, k = 0, l = gdjs.TextoCode.GDtextoObjects1.length;i<l;++i) {
    if ( gdjs.TextoCode.GDtextoObjects1[i].getAnimation() != 6 ) {
...
gdjs.TextoCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(7441460);
}
}}
}
}
...
{
{gdjs.TextoCode.conditionTrue_1 = gdjs.TextoCode.condition4IsTrue_0;
gdjs.TextoCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8290604);
}
}}
}
}
...
{
{gdjs.TextoCode.conditionTrue_1 = gdjs.TextoCode.condition4IsTrue_0;
gdjs.TextoCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(7533572);
}
}}
}
}
...
{
{gdjs.TextoCode.conditionTrue_1 = gdjs.TextoCode.condition4IsTrue_0;
gdjs.TextoCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8641540);
}
}}
}
}
