...
gdjs.A1Code.GD6Objects1_1final = [];
...
gdjs.A1Code.GD6Objects1= [];
gdjs.A1Code.GD6Objects2= [];
...
gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD1Objects2Objects = Hashtable.newFrom({"1": gdjs.A1Code.GD1Objects2});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD4Objects2Objects = Hashtable.newFrom({"4": gdjs.A1Code.GD4Objects2});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD6Objects2Objects = Hashtable.newFrom({"6": gdjs.A1Code.GD6Objects2});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDareaObjects1Objects = Hashtable.newFrom({"area": gdjs.A1Code.GDareaObjects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD1Objects1Objects = Hashtable.newFrom({"1": gdjs.A1Code.GD1Objects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDareaObjects1Objects = Hashtable.newFrom({"area": gdjs.A1Code.GDareaObjects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD4Objects1Objects = Hashtable.newFrom({"4": gdjs.A1Code.GD4Objects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDareaObjects1Objects = Hashtable.newFrom({"area": gdjs.A1Code.GDareaObjects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD6Objects1Objects = Hashtable.newFrom({"6": gdjs.A1Code.GD6Objects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDareaObjects1Objects = Hashtable.newFrom({"area": gdjs.A1Code.GDareaObjects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD3Objects1Objects = Hashtable.newFrom({"3": gdjs.A1Code.GD3Objects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDareaObjects1Objects = Hashtable.newFrom({"area": gdjs.A1Code.GDareaObjects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD2Objects1Objects = Hashtable.newFrom({"2": gdjs.A1Code.GD2Objects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDareaObjects1Objects = Hashtable.newFrom({"area": gdjs.A1Code.GDareaObjects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD5Objects1Objects = Hashtable.newFrom({"5": gdjs.A1Code.GD5Objects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDvoltarAoTxtObjects1Objects = Hashtable.newFrom({"voltarAoTxt": gdjs.A1Code.GDvoltarAoTxtObjects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDvoltarAtivObjects1Objects = Hashtable.newFrom({"voltarAtiv": gdjs.A1Code.GDvoltarAtivObjects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDforwardButtonObjects1Objects = Hashtable.newFrom({"forwardButton": gdjs.A1Code.GDforwardButtonObjects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDforwardButtonObjects1Objects = Hashtable.newFrom({"forwardButton": gdjs.A1Code.GDforwardButtonObjects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDbackButtonObjects1Objects = Hashtable.newFrom({"backButton": gdjs.A1Code.GDbackButtonObjects1});gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDbackButtonObjects1Objects = Hashtable.newFrom({"backButton": gdjs.A1Code.GDbackButtonObjects1});gdjs.A1Code.eventsList0xb25a8 = function(runtimeScene) {
...
gdjs.A1Code.condition1IsTrue_0.val = false;
{
gdjs.A1Code.condition0IsTrue_0.val = gdjs.evtTools.common.getVariableNumber(runtimeScene.getVariables().getFromIndex(0)) == 1;
}if ( gdjs.A1Code.condition0IsTrue_0.val ) {
{
gdjs.A1Code.condition1IsTrue_0.val = gdjs.evtTools.runtimeScene.timerElapsedTime(runtimeScene, 1.5, "timer");
}}
...
{runtimeScene.getVariables().getFromIndex(1).setNumber(gdjs.random(6));
    ...
    gdjs.A1Code.GDvoltarAoTxtObjects1[i].setPosition(802,173);
}
...
gdjs.A1Code.GD6Objects1.length = 0;
...
gdjs.A1Code.condition2IsTrue_0.val = false;
{
{gdjs.A1Code.conditionTrue_1 = gdjs.A1Code.condition0IsTrue_0;
gdjs.A1Code.GD1Objects1_1final.length = 0;gdjs.A1Code.GD4Objects1_1final.length = 0;gdjs.A1Code.GD6Objects1_1final.length = 0;gdjs.A1Code.condition0IsTrue_1.val = false;
gdjs.A1Code.condition1IsTrue_1.val = false;
gdjs.A1Code.condition2IsTrue_1.val = false;
{
...
{
gdjs.A1Code.GD6Objects2.createFrom(runtimeScene.getObjects("6"));
gdjs.A1Code.condition2IsTrue_1.val = gdjs.evtTools.input.cursorOnObject(gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD6Objects2Objects, runtimeScene, true, false);
if( gdjs.A1Code.condition2IsTrue_1.val ) {
    gdjs.A1Code.conditionTrue_1.val = true;
    for(var j = 0, jLen = gdjs.A1Code.GD6Objects2.length;j<jLen;++j) {
        if ( gdjs.A1Code.GD6Objects1_1final.indexOf(gdjs.A1Code.GD6Objects2[j]) === -1 )
            gdjs.A1Code.GD6Objects1_1final.push(gdjs.A1Code.GD6Objects2[j]);
    }
}
}
{
...
gdjs.A1Code.GD6Objects1.createFrom(gdjs.A1Code.GD6Objects1_1final);
}
}
}if ( gdjs.A1Code.condition0IsTrue_0.val ) {
{
...
gdjs.A1Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9040596);
}
}}
}
...
gdjs.A1Code.GD5Objects1.createFrom(runtimeScene.getObjects("5"));
gdjs.A1Code.GD6Objects1.createFrom(runtimeScene.getObjects("6"));
gdjs.A1Code.GDareaObjects1.createFrom(runtimeScene.getObjects("area"));
...
gdjs.A1Code.condition3IsTrue_1.val = false;
{
gdjs.A1Code.condition0IsTrue_1.val = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDareaObjects1Objects, gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD1Objects1Objects, true, runtimeScene, false);
}if ( gdjs.A1Code.condition0IsTrue_1.val ) {
{
gdjs.A1Code.condition1IsTrue_1.val = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDareaObjects1Objects, gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD4Objects1Objects, true, runtimeScene, false);
}if ( gdjs.A1Code.condition1IsTrue_1.val ) {
{
gdjs.A1Code.condition2IsTrue_1.val = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDareaObjects1Objects, gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD6Objects1Objects, true, runtimeScene, false);
}if ( gdjs.A1Code.condition2IsTrue_1.val ) {
{
gdjs.A1Code.condition3IsTrue_1.val = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDareaObjects1Objects, gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD3Objects1Objects, true, runtimeScene, false);
}}
}
}
gdjs.A1Code.conditionTrue_1.val = true && gdjs.A1Code.condition0IsTrue_1.val && gdjs.A1Code.condition1IsTrue_1.val && gdjs.A1Code.condition2IsTrue_1.val && gdjs.A1Code.condition3IsTrue_1.val;
}
}if ( gdjs.A1Code.condition0IsTrue_0.val ) {
{
gdjs.A1Code.condition1IsTrue_0.val = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDareaObjects1Objects, gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD2Objects1Objects, false, runtimeScene, false);
}if ( gdjs.A1Code.condition1IsTrue_0.val ) {
{
gdjs.A1Code.condition2IsTrue_0.val = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.A1Code.mapOfGDgdjs_46A1Code_46GDareaObjects1Objects, gdjs.A1Code.mapOfGDgdjs_46A1Code_46GD5Objects1Objects, false, runtimeScene, false);
}if ( gdjs.A1Code.condition2IsTrue_0.val ) {
{
{gdjs.A1Code.conditionTrue_1 = gdjs.A1Code.condition3IsTrue_0;
gdjs.A1Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9472124);
}
}}
}
}
...
gdjs.A1Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9639508);
}
}}
}
}
...
{
{gdjs.A1Code.conditionTrue_1 = gdjs.A1Code.condition4IsTrue_0;
gdjs.A1Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9652516);
}
}}
}
}
...
gdjs.A1Code.GD6Objects1.length = 0;
gdjs.A1Code.GD6Objects2.length = 0;
