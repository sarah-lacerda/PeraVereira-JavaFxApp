...
gdjs.FimCode.condition1IsTrue_0.val = false;
{
gdjs.FimCode.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.FimCode.mapOfGDgdjs_46FimCode_46GDvoltarAoMenuObjects1Objects, runtimeScene, true, false);
}if ( gdjs.FimCode.condition0IsTrue_0.val ) {
{
gdjs.FimCode.condition1IsTrue_0.val = gdjs.evtTools.input.isMouseButtonReleased(runtimeScene, "Left");
}}
